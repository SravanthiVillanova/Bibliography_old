<?php /* Smarty version 2.6.25-dev, created on 2016-09-01 19:59:31
         compiled from publisher-delete.tpl */ ?>
<form method="post">
...
<ul>
  <?php $_from = $this->_tpl_vars['pubList']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['pub']):
?>
  <li><?php echo $this->_tpl_vars['pub']->name; ?>
</li>
  <input type="hidden" name="id[]" value="<?php echo $this->_tpl_vars['pub']->id; ?>
">
